        ...
        <div className="formulario-reservacion-container">
            <div className="formulario-reservacion">
                <div className="formulario-reservacion-input">
                   ...
                   <input onBlur={ ( e ) => manejarCambio( e.target ) } type="text" name="nombre" placeholder='Nombre de la reserva' />
                </div>
                <div className="formulario-reservacion-input">
                   ...
                   <input onBlur={ ( e ) => manejarCambio( e.target ) } type="date" name="dia" defaultValue={ `${ año }-${ ( mes < 10 ? '0' : '' ) + mes }-${ ( dia < 10 ? '0' : '' ) + dia }` } />
                </div>
                <div className="formulario-reservacion-input">
                   ...
                   <input onBlur={ ( e ) => manejarCambio( e.target ) }  type="time" name="hora" defaultValue={`${ ( hora < 10 ? '0' : '' ) + hora }:${ ( minutos < 10 ? '0' : '') + minutos }`} />
                </div>
                <div className="formulario-reservacion-input">
